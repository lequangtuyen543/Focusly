    ...
    <div className={`min-h-screen text-canvas-white font-body flex flex-col transition-colors duration-500 ease-in-out ${bgClass}`}>
      ...
      <footer className="w-full py-12 border-t border-outline-variant/10 bg-transparent mt-auto">
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between items-center px-8 gap-4">
          ...
          <div className="font-caption text-caption text-cool-gray opacity-80 hover:opacity-100 duration-200">
            &copy; {new Date().getFullYear()} Focusly. Deep focus, architected.
          </div>
          <div className="flex gap-6">
            <a className="font-caption text-caption text-cool-gray hover:text-cofounder-blue transition-colors" href="#">Privacy Policy</a>
            <a className="font-caption text-caption text-cool-gray hover:text-cofounder-blue transition-colors" href="#">Terms of Service</a>
            <a className="font-caption text-caption text-cool-gray hover:text-cofounder-blue transition-colors" href="#">Support</a>
          </div>
        </div>
      </footer>
    </div>
